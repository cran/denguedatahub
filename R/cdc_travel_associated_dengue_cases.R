...
#' @description Travel associated dengue cases by year, 2010 - 2023 in the US, 2010 - 2023 published by the US Centers for Disease Control and Prevention (CDC)
#' @format A tibble with 14 rows and 3 variables:
#' \describe{
#'   \item{Year}{Year} 
#'   \item{Travel.status}{Travel status}
#'   \item{Reported.cases}{Number of reported cases}
#'   }
